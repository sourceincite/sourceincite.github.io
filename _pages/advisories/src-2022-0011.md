---
layout: page
permalink: /advisories/src-2022-0011/
id: SRC-2022-0011
atitle: VMware Workspace ONE Access gatherConfig.hzn Privilege Escalation Vulnerability
CVE: CVE-2022-22960
CVSSrating: 7.8
...
body: |
 ...
 The specific flaw exists within gatherConfig.hzn script. The issue results from allowing attackers to take ownership of sensitive files. An attacker can leverage this vulnerability to escalate privileges and execute arbitrary code in the context of root.
acknowledgments:
poc:
---
