---
layout: page
permalink: /advisories/src-2018-0015/
id: SRC-2018-0015
atitle: Foxit Reader PDF Parsing U3D Out-of-Bounds Read Remote Code Execution Vulnerability
CVE: CVE-2018-5679
CVSSrating: 6.8
...
body: |
 ...
 <p class="cn" markdown="1">The specific flaw exists within the parsing of embedded U3D images inside of PDF files. The issue results from the lack of proper validation of user-supplied data, which can result in a read past the end of an allocated buffer. An attacker can leverage this vulnerability to execute code under the context of the current process.</p>
poc:
---
