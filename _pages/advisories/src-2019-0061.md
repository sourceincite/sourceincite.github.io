---
layout: page
permalink: /advisories/src-2019-0061/
id: SRC-2019-0061
atitle: Adobe Photoshop CC ASCII85Decode filter Heap Buffer Overflow Remote Code Execution Vulnerability
CVE: CVE-2019-7972
CVSSrating: 7.8
...
body: |
 ...
 <p class="cn" markdown="1">The specific flaw exists within the processing of Encapsulated PostScript files. The issue results from the lack of proper validation of the length of user-supplied data prior to copying it to a fixed-length heap-based buffer. An attacker can leverage this vulnerability to execute code in the context of the current process.</p>
acknowledgments: |
