---
layout: page
permalink: /advisories/src-2019-0004/
id: SRC-2019-0004
atitle: Foxit Reader SDK ActiveX Pro launchURL Command Injection Remote Code Execution Vulnerability
CVE: CVE-2018-19445
CVSSrating: 7.5
...
body: |
 ...
 <p class="cn" markdown="1">The specific flaw exists within app.launchURL method. The issue results from the lack of proper validation of a user-supplied string before using it to execute a system call. An attacker can leverage this vulnerability to execute code under the context of the current process.</p>
---
