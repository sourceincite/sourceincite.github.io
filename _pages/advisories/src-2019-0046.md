---
layout: page
permalink: /advisories/src-2019-0046/
id: SRC-2019-0046
atitle: Hewlett Packard Intelligent Management Center Standard AirWaveApConvergedDaoImpl readListBySql SQL Injection Remote Code Execution Vulnerability
CVE: CVE-2019-11977
CVSSrating: 8.8
...
body: |
 ...
 <p class="cn" markdown="1">The specific flaw exists within the handling of the readListBySql function. The issue results from the lack of proper validation of a user-supplied string before using it to construct SQL queries. An attacker can leverage this vulnerability to execute code in the context of SYSTEM.</p>
acknowledgments: |
