---
layout: page
permalink: /advisories/src-2021-0023/
id: SRC-2021-0023
atitle: Foxit Reader Annotation transitionToState Use-After-Free Remote Code Execution Vulnerability
CVE: CVE-2021-41780
CVSSrating: 8.8
...
body: |
 ...
 <p class="cn" markdown="1">The specific flaw exists within the handling of Annotation objects. The issue results from the lack of validating the existence of an object prior to performing operations on the object. An attacker can leverage this vulnerability to execute code in the context of the current process.</p>
acknowledgments:
poc: /pocs/src-2021-0023.pdf.txt
---
