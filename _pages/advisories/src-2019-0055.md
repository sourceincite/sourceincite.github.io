---
layout: page
permalink: /advisories/src-2019-0055/
id: SRC-2019-0055
atitle: Hewlett Packard Enterprise Intelligent Management Center ConfFileResource syncaddOrModFile Directory Traversal Remote Code Execution Vulnerability
CVE: CVE-2019-11968
CVSSrating: 8.8
...
body: |
 ...
 <p class="cn" markdown="1">The specific flaw exists within the handling of the syncaddOrModFile function. The issue results from the lack of proper validation of a user-supplied string which can lead to arbitrary file creation. An attacker can leverage this vulnerability to execute code in the context of SYSTEM.</p>
acknowledgments: |
