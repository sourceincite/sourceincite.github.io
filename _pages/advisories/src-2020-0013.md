---
layout: page
permalink: /advisories/src-2020-0013/
id: SRC-2020-0013
atitle: Cisco UCS Director MyCallable call Directory Traversal Remote Code Execution Vulnerability
CVE: CVE-2020-3251
CVSSrating: 8.1
...
body: |
 ...
 <p class="cn" markdown="1">The specific flaw exists within the MyCallable class. The issue results from the lack of proper validation of a user-supplied path prior to using it in file operations. An attacker can leverage this vulnerability to execute code in the context of the tomcatu account.</p>
poc:
---
