---
layout: page
permalink: /advisories/src-2019-0009/
id: SRC-2019-0009
atitle: Foxit Reader SDK ActiveX Launch Action New Window Command Injection Remote Code Execution Vulnerability
CVE: CVE-2018-19418
CVSSrating: 7.5
...
body: |
 ...
 <p class="cn" markdown="1">The specific flaw exists within the Launch action using new windows. The issue results from the lack of proper validation of a user-supplied string before using it to execute a system call. An attacker can leverage this vulnerability to execute code under the context of the current process.</p>
poc: /pocs/src-2019-0009.py.txt
---
