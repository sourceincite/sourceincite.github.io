---
layout: page
permalink: /advisories/src-2019-0060/
id: SRC-2019-0060
atitle: Adobe Photoshop CC EPS Type 1 Font FontBBox array Stack Buffer Overflow Remote Code Execution Vulnerability
CVE: CVE-2019-7973
CVSSrating: 7.8
...
body: |
 ...
 <p class="cn" markdown="1">The specific flaw exists within the processing of PostScript files. The issue results from the lack of proper validation of the length of user-supplied data prior to copying it to a fixed-length stack-based buffer. An attacker can leverage this vulnerability to execute code in the context of the current process.</p>
acknowledgments: |
