---
layout: page
permalink: /advisories/src-2020-0007/
id: SRC-2020-0007
atitle: Cisco Data Center Network Manager SystemFileDAO deleteFile Directory Traversal Denial of Service Vulnerability
CVE: CVE-2019-15980
CVSSrating: 7.1
...
body: |
 ...
 <p class="cn" markdown="1">The specific flaw exists within the processing of requests to the deleteSystemData endpoint of the SystemFileDAO Data Access Object. When parsing the path parameter in the deleteFile method, the process does not properly validate a user-supplied path prior to using it in file operations. An attacker can leverage this vulnerability to delete files in the context of SYSTEM and to create a denial-of-service condition.</p>
poc:
---
