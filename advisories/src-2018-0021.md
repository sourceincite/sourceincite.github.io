---
layout: page
permalink: /advisories/src-2018-0021/
id: SRC-2018-0021
atitle: Adobe Acrobat Pro DC img setAttribute Use-After-Free Remote Code Execution Vulnerability
CVE: CVE-2018-12791
CVSSrating: 6.8
...
body: |
 ...
 <p class="cn" markdown="1">The specific flaw exists within the handling of img objects when calling setAttribute. The issue results from the lack of validating the existence of an object prior to performing operations on the object. An attacker can leverage this vulnerability to execute code in the context of the current process.</p>
acknowledgments: |
