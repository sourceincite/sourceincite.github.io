...
id: SRC-2019-0083
atitle: Cisco Prime Infrastructure XmpFileUploadServlet Command Injection Remote Code Execution Vulnerability
CVE: CVE-2019-15958
CVSSrating: 8.8
...
body: |
 ...
 <p class="cn" markdown="1">The specific flaw exists within the XmpFileUploadServlet servlet. The issue results from the lack of proper validation of a user-supplied path prior to using it in a system call. An attacker can leverage this vulnerability to execute code under the context of root.</p>
poc:
---
