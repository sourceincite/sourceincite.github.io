---
layout: page
permalink: /advisories/src-2019-0058/
id: SRC-2019-0058
atitle: Adobe Photoshop CC Type 2 Font Charstring callothersubr Type Confusion Remote Code Execution Vulnerability
CVE: CVE-2019-7975
CVSSrating: 7.8
...
2018-08-15 – Coordinated public release of advisory
]
...
body: |
 ...
 <p class="cn" markdown="1">The specific flaw exists within the processing of PostScript files. The issue results from the lack of proper validation of user-supplied data, which can result in a type confusion condition and subsequent out-of-bounds write on the stack. An attacker can leverage this vulnerability to execute code in the context of the current process.</p>
acknowledgments: |
