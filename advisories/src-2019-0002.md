---
layout: page
permalink: /advisories/src-2019-0002/
id: SRC-2019-0002
atitle: Foxit Reader SDK ActiveX Pro TextBox Field Validate Use-After-Free Remote Code Execution Vulnerability
CVE: CVE-2018-19444
CVSSrating: 7.5
...
body: |
 ...
 <p class="cn" markdown="1">The specific flaw exists within the handling of Validate events on fields. The issue results from the lack of validating the existence of an object prior to performing operations on the object. An attacker can leverage this vulnerability to execute code in the context of the current process.</p>
---
